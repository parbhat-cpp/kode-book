...
import { supportedLanguages } from "@/constants/homepage";
import Image from "next/image";

const firstRow = supportedLanguages.slice(0, supportedLanguages.length / 2);
const secondRow = supportedLanguages.slice(supportedLanguages.length / 2);
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2">
        <Image className="rounded-full" width="32" height="32" alt={alt} src={src} />
